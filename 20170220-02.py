...
def DailyQuoCSV(sear_date):
	...
	str_url = "http://www.tpex.org.tw/web/stock/aftertrading/otc_quotes_no1430B/stk_wn1430_download.php?l=zh-tw&f=SQUOTE_AL_" + sear_date.replace("/","") + ".CSV"
...
############################################################################
"""
抓取位於舊版網頁上，上櫃收盤資料，介於2007/04/23~2007/06/30間的資料
"""

print("Executing 20170220-02...")
