...
#開啟券商進出分點網頁，讀取執行完後的頁面source code
driver.get('https://www.nvesto.com/tpe/0050/majorforce#!/fromdate/2017-07-12/todate/2017-07-12/view/summary')
pageSource = driver.page_source
#print(pageSource)
...
#讀取券商進出分點買賣超資料
#table_all = sp.findAll('table', attrs={'class':'table table-bordered'})
#print(table_all)
